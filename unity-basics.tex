...
\begin{exerciseframe}{Variant or Copy?}
  The player avatars live in \texttt{Resources/Prefabs/Players/CC4}: sixteen
  characters --- \texttt{Caleb}, \texttt{Hanna}, \texttt{Karl} and the rest ---
  over one \texttt{BaseAvatar}.
  \vspace{1ex}
  ...
  \begin{enumerate}
    ...
    \item One of the sixteen is \emph{not} a variant. How do you find out which
      one, without opening all sixteen in the inspector?
...
\begin{solutionframe}{Variant or Copy?}
  \begin{enumerate}
    ...
    \item It will not arrive. All sixteen files already override the root
      \texttt{m\_LocalPosition} --- every one of them to $(0, 0, 0)$ --- and an
