...
\begin{frame}{The Operators You Will Actually Use}
  \begin{itemize}
...
(from n in nodes
 ...
 select n.Id).ToList();
  ...
  \hint{SEE uses method syntax exclusively: its sources contain no single query
  expression. Follow that convention.}
\end{frame}
...
\begin{exerciseframe}{Select or SelectMany?}
  Every node carries a list of children. Predict both numbers and, more
  importantly, both static types.
  \vspace{1ex}
