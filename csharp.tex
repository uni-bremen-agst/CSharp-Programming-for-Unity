...
public int Count
{
  ...
  \hint{\texttt{value} is the implicit parameter of the setter. Since call sites
  never change, you can start with an auto-implemented property and add
  validation later -- which is why C\# exposes properties where Java exposes
  getters and setters.}
\end{solutionframe}
